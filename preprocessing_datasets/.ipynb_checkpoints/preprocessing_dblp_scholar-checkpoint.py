...
def clean_dblp_scholar():

    dirname = os.path.dirname(__file__)
    path_dataset1 = os.path.join(dirname, '../source_datasets/DBLP-Scholar/DBLP1.csv')
    path_dataset2 = os.path.join(dirname, '../source_datasets/DBLP-Scholar/Scholar1.csv')
    path_dataset3 = os.path.join(dirname, '../source_datasets/DBLP-Scholar/DBLP-Scholar_perfectMapping.csv')
    ...
    for pair in zip(table_match['idDBLP'], table_match['idScholar']):
